...
public class UntMstInfoDTO {
	private String UNTCD;
	private String UNTNM;
	private String UNTCEO;
	...
	public String getUNTCEO() {
		return UNTCEO;
	}
	public void setUNTCEO(String uNTCEO) {
		UNTCEO = uNTCEO;
	}
	...
	public String getREGDATIME() {
		return REGDATIME;
	}
	public void setREGDATIME(String rEGDATIME) {
		REGDATIME = rEGDATIME;
	}
	public String getEDTDATIME() {
		return EDTDATIME;
	}
